                    ...
                    <div className="grid grid-cols-2 max-sm:gap-y-12 gap-8 sm:grid-cols-3 lg:col-span-2">
                        {/* <div>
                            ...
                            <ul className="mt-6 space-y-4 text-sm">
                                <li>
                                    <a href="#" className="text-gray-300/95 transition hover:opacity-75">
                        ...
                        <div>
                            <p className="font-medium text-gray-100 text-xl">Company</p>
                            <ul className="mt-6 space-y-4 text-sm">
                                <li>
                                    <a href="#" className="text-gray-300/95 transition hover:opacity-75">
                                        About
                        ...
                        <div>
                            <p className="font-medium text-gray-100 text-xl">Helpful Links</p>
                            <ul className="mt-6 space-y-4 text-sm">
                                <li>
                                    <a href="#" className="text-gray-100/95 transition hover:opacity-75">
                                        Contact
                                    </a>
                                </li>
                                <li>
